  ...
  return (
    <section className="w-full bg-white py-12 md:py-16" aria-label="Trending products">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        <div className="mb-8 flex flex-row items-start justify-between gap-3 sm:gap-6 sm:items-end">
          <h2
            className="min-w-0 flex-1 pr-1 text-lg sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl font-light text-black text-left leading-[1.15] sm:leading-tight tracking-tight"
